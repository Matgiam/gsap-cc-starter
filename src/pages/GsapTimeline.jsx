...
const GsapTimeline = () => {
	...
	useGSAP(() => {
		timeline.to("#yellow-box", { x: 250, rotation: 360, borderRadius: "50%", duration: 2, ease: "back.inOut" });
		timeline.to("#yellow-box", { y: 20, scale: 0.5, borderRadius: "25%", duration: 2, ease: "back.inOut" });
		timeline.to("#yellow-box", { x: 500, rotation: 0, borderRadius: "0%", duration: 2, scale: 2, ease: "back.inOut" });
	}, []);
	return (
		<main>
			<h1>GsapTimeline</h1>
